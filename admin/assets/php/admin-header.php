  ...
  <div class="container-fluid">
    <div class="row">
      <div class="admin-nav p-0">
        <h4 class="text-light text-center p-.5">Russell Elementary Admin Panel<a href="#" class="text-light float-right" id="close-nav"><i class="fas fa-times"></i></a></h4>
        <div class="list-group list-group-flush">
          ...
          <a href="<?= $base_url ?>/admin/admin-documents.php" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) == 'admin-documents.php') ? 'nav-active' : ''; ?>"><i class="fas fa-comment"></i>&nbsp;&nbsp;Documents</a>
