      ...
      <div class="card rounded-0 mt-3 border-danger">
        <div class="card-header border-daner">
          <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
              <a class="nav-link active font-weight-bold text-danger" data-toggle="tab" href="#profile">Profile</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font-weight-bold text-danger" data-toggle="tab" href="#editprofile">Edit Profile</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font-weight-bold text-danger" data-toggle="tab" href="#changepass">Change Password</a>
            </li>
          </ul>
        </div>
        <style> 
              ...
              <div class="card-deck">
                <div class="card border-danger">
                  ...
                  <form action="#" method="post" class="px-3 mt-2" id="change-pass-form">
                    ...
                    <div class="form-group">
                      <input type="submit" name="changepass" value="Change Password" class="btn btn-danger btn-block btn-lg" id="changePassBtn">
                    </div>
                  </form>
                </div>
