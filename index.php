...
<body class="bg-info bg-danger ">
  <div class="container">
    <!-- Login Box Start -->
    <div class="row justify-content-center wrapper bg-danger" id="login-box">
      <div class="col-lg-10 my-auto">
        <div class="card-group myShadow">
          <div class="card rounded-left p-4" style="flex-grow:1.4;">
            <h1 class="text-center font-weight-bold text-danger">Russell Elementary:    Sign into Account</h1>
            <hr class="my-3">
  ...
  echo $_COOKIE['password'];
              ...
              <div class="form-group">
                ...
                <div class="forgot float-right text-danger">
                  <a href="#" id="forgot-link">Forgot Password?</a>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="form-group">
                <input type="submit" id="login-btn" value="Sign In" class="btn btn-danger btn-lg btn-block myBtn">
              </div>
            </form>
          </div>
          <div class="card justify-content-center rounded-right myColor p-4">
            <h1 class="text-center font-weight-bold text-danger">Hello Teachers and Guest Teachers</h1>
            <hr class="my-3 bg-dark myHr">
            <p class="text-center font-weight-bolder text-danger lead">Please enter your personal details to login.</p>
            <button class="btn btn-outline-light bg-danger btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="register-link">Sign Up</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-10 my-auto">
        <div class="card-group myShadow">
          <div class="card rounded-left myColor p-4 justify-content-center">
            <h1 class="text-center font-weight-bold text-danger">Welcome Back!</h1>
            <hr class="my-4 bg-light myHr">
            <p class="text-center font-weight-bolder text-danger lead">Please enter your personal info and sign into system.</p>
            <button class="btn btn-outline-light bg-danger btn-lg font-weight-bolder mt-4 align-self-center myLinkBtn" id="login-link">Sign In</button>
          </div>
          <div class="card rounded-right p-4" style="flex-grow:1.4">
            <h1 class="text-center font-weight-bold text-danger">Create Account</h1>
            <hr class="my-3">
            ...
            <form action="#" method="post" class="px-3" id="register-form">
              ...
              <div class="form-group">
                <input type="submit" id="register-btn" value="Sign Up" class="btn btn-danger btn-lg btn-block myBtn">
              </div>
            </form>
          </div>
        </div>
    ...
    <div class="row justify-content-center wrapper" id="forgot-box" style="display: none;">
      <div class="col-lg-10 my-auto">
        <div class="card-group myShadow">
          <div class="card rounded-left myColor p-4 justify-content-center">
            <h1 class="text-center font-weight-bold text-danger">Reset Password</h1>
            <hr class="my-4 bg-danger myHr">
            <button class="btn dg-danger btn-outline-dark btn-lg font-weight-bolder myLinkBtn align-self-center" id="back-link">Back</button>
          </div>
          <div class="col-lg-7 bg-white rounded-right p-4">
            <h1 class="text-center font-weight-bold text-danger">Forgot Your Password?</h1>
            <hr class="my-3">
            <p class="lead text-center text-danger">To reset your password, enter the registered e-mail adddress and we will send you password reset instructions on your e-mail!</p>
            <form action="#" method="post" class="px-3" id="forgot-form">
              ...
              <div class="form-group">
                <input type="submit" id="forgot-btn" value="Reset Password" class="btn btn-danger btn-lg btn-block myBtn">
              </div>
            </form>
          </div>
        </div>
